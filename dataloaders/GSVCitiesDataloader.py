...
from drive.MyDrive.Project.code.dataloaders.train.GSVCitiesDataset import GSVCitiesDataset
...
class GSVCitiesDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage):
        '''
        function to assign dataset to a dataloader
        '''
        ...
        if stage == 'fit':
            ...
            for valid_set_name in self.val_set_names:
              if 'sfxs_val' in valid_set_name.lower():
                self.val_datasets.append(SanFranciscoXSDataset(which_ds='val',
